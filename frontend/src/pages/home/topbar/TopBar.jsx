...
const TopBar = () => {
	...
	return (
		<div className="fixed left-0 -top-20 w-full flex md:hidden justify-between px-4 py-2 border-b border-gray-700 z-50 shadow-2xl bg-gray-300 dark:bg-slate-900 transition-all duration-300 topbar delay-0">
